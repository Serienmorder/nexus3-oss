...
class LookupModule(LookupBase):
    ...
    def run(self, terms, variables, **kwargs):
        ...
        for term in terms:
            ...
            lookupfile = self.find_file_in_search_path(variables, 'scripts', term)
            ...
            if lookupfile:
                ...
                if searchpath:
                    ...
                    newsearchpath = []
                    for p in searchpath:
                        newsearchpath.append(os.path.join(p, 'scripts'))
                ...
                raise AnsibleError("the script file %s could not be found for the lookup" % term)
